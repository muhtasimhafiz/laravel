        ...
        <div class="container">
            <div class="col-md-4 col-sm-6">
                <div class="service-item">
                    <div class="icon">
                        <img src="{{asset('website')}}/img/service_1.png" alt="">
                    </div>
                    <div class="text">
            ...
            <div class="col-md-4 col-sm-6">
                <div class="service-item">
                    <div class="icon">
                        <img src="{{asset('website')}}/img/service_2.png" alt="">
                    </div>
                    <div class="text">
            ...
            <div class="col-md-4 col-sm-6">
                <div class="service-item">
                    <div class="icon">
                        <img src="{{asset('website')}}/img/service_3.png" alt="">
                    </div>
                    <div class="text">
            ...
            <div class="col-md-4 col-sm-6">
                <div class="service-item">
                    <div class="icon">
                        <img src="{{asset('website')}}/img/service_4.png" alt="">
                    </div>
                    <div class="text">
            ...
            <div class="col-md-4 col-sm-6">
                <div class="service-item">
                    <div class="icon">
                        <img src="{{asset('website')}}/img/service_5.png" alt="">
                    </div>
                    <div class="text">
            ...
            <div class="col-md-4 col-sm-6">
                <div class="service-item">
                    <div class="icon">
                        <img src="{{asset('website')}}/img/service_6.png" alt="">
                    </div>
                    <div class="text">
